...
export function FooterDesignB() {
  ...
  return (
    <footer className="bg-[#080F1A] text-white relative">
      {/* Top Gold Line */}
        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <div className="space-y-3 mt-6">
              <div className="flex items-center gap-3 text-sm text-white/50 hover:text-[#C9A962] transition-colors">
              ...
              <div className="flex items-start gap-3 text-sm text-white/50">
                <MapPin className="w-4 h-4 text-[#C9A962] shrink-0 mt-0.5" />
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="font-medium text-sm mb-5 text-[#C9A962] tracking-wide">
                {category}
              </h4>
